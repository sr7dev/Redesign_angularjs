...
;(function(window, $, undefined) {
	...
	var cache = {
		$carouselContainer: $('.thumbnails-carousel_5').parent(),
		$thumbnailsLi: $('.thumbnails-carousel_5 li'),
		$controls: $('.thumbnails-carousel_5').parent().find('.carousel-control')
	};
	...
	$.fn.thumbnailsCarousel_5 = function(options) {
		conf = $.extend(conf, options);
...
$('.thumbnails-carousel_5').thumbnailsCarousel_5();
...
;(function(window, $, undefined) {
	...
	var cache = {
		$carouselContainer: $('.thumbnails-carousel_6').parent(),
		$thumbnailsLi: $('.thumbnails-carousel_6 li'),
		$controls: $('.thumbnails-carousel_6').parent().find('.carousel-control')
	};
	...
	$.fn.thumbnailsCarousel_6 = function(options) {
		conf = $.extend(conf, options);
...
$('.thumbnails-carousel_6').thumbnailsCarousel_6();
...
;(function(window, $, undefined) {
	...
	var cache = {
		$carouselContainer: $('.thumbnails-carousel_7').parent(),
		$thumbnailsLi: $('.thumbnails-carousel_7 li'),
		$controls: $('.thumbnails-carousel_7').parent().find('.carousel-control')
	};
	...
	$.fn.thumbnailsCarousel_7 = function(options) {
		conf = $.extend(conf, options);
...
$('.thumbnails-carousel_7').thumbnailsCarousel_7();
...
;(function(window, $, undefined) {
	...
	var cache = {
		$carouselContainer: $('.thumbnails-carousel_8').parent(),
		$thumbnailsLi: $('.thumbnails-carousel_8 li'),
		$controls: $('.thumbnails-carousel_8').parent().find('.carousel-control')
	};
	...
	$.fn.thumbnailsCarousel_8 = function(options) {
		conf = $.extend(conf, options);
...
$('.thumbnails-carousel_8').thumbnailsCarousel_8();